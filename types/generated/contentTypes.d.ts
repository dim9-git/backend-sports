...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    leftLinks: Schema.Attribute.Component<'header.header-link', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::header.header'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    rightLinks: Schema.Attribute.Component<'header.header-link', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiLeagueLeague extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::league.league'>;
    news: Schema.Attribute.Relation<'manyToMany', 'api::new.new'>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false> &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiNewNew extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    awayTeams: Schema.Attribute.Relation<'manyToMany', 'api::team.team'>;
    categories: Schema.Attribute.Relation<
      'manyToMany',
      'api::category.category'
    >;
    content: Schema.Attribute.DynamicZone<
      ['content-types.text', 'content-types.gallery']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    contentTypes: Schema.Attribute.Relation<
      'manyToMany',
      'api::content-type.content-type'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    homeTeams: Schema.Attribute.Relation<'manyToMany', 'api::team.team'>;
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    awayNews: Schema.Attribute.Relation<'manyToMany', 'api::new.new'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text &
    ...
    homeNews: Schema.Attribute.Relation<'manyToMany', 'api::new.new'>;
    image: Schema.Attribute.Media<'files' | 'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
